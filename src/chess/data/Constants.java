...
public class Constants {
	...
	/*
	 * This class keeps track of Constant values that will be used across the project.
	 */
	
	// each of these constants represents the index that they appear within the bitboards array
